...
- (void)showToast:(NSString *) msg
{
    ...
    //view.center = CGPointMake(ScreenWidth/2, ScreenHeight/2+150);
    //    view.center = CGPointMake(ScreenWidth/2, ScreenHeight-TabBarHeight-NaviBarHeight-view.frame.size.height-view.frame.size.height/2-20);
