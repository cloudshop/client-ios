 ...
 */
@property (nonatomic, strong) UIFont *selectedTitleFont UI_APPEARANCE_SELECTOR;
 ...
 */
@property (nonatomic, strong) UIColor *segmentIndicatorBackgroundColor UI_APPEARANCE_SELECTOR;
 ...
 */
@property (nonatomic, strong) UIColor *segmentIndicatorGradientTopColor UI_APPEARANCE_SELECTOR;
...
/**
 ...
 @see drawsSegmentIndicatorGradientBackground
 */
@property (nonatomic, strong) UIColor *segmentIndicatorGradientBottomColor UI_APPEARANCE_SELECTOR;

/**
 The color of the selected segment indicator's border
 */
@property (nonatomic, strong) UIColor *segmentIndicatorBorderColor UI_APPEARANCE_SELECTOR;
