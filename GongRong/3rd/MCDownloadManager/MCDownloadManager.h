...
//由于在本次项目中url会变 只好将url属性readOnly去掉变成可改写的  @property (nonatomic, copy, readonly, nonnull) NSString *url;
@property (nonatomic,readwrite, copy, nonnull) NSString *url;
...
@property (nonatomic, copy, readonly, nullable) NSString *courseTypeName;
@property (nonatomic, copy, readonly, nullable) NSString *courseName;
@property (nonatomic, copy, readonly, nullable) NSString *courseTypeIMg;
...
- (MCDownloadReceipt *)downloadFileWithFileName:(NSString * _Nullable)fileName AndUrl:(NSString *)url
